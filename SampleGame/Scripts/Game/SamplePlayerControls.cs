        ...
        public struct Sample_UITesterActions
        {
            ...
            public void SetCallbacks(ISample_UITesterActions instance)
            {
                if (m_Wrapper.m_Sample_UITesterActionsCallbackInterface != null)
                {
                    ...
                    @TestAxis.started -= m_Wrapper.m_Sample_UITesterActionsCallbackInterface.OnTestAxis;
                    @TestAxis.performed -= m_Wrapper.m_Sample_UITesterActionsCallbackInterface.OnTestAxis;
                    @TestAxis.canceled -= m_Wrapper.m_Sample_UITesterActionsCallbackInterface.OnTestAxis;
                    @TestVector2.started -= m_Wrapper.m_Sample_UITesterActionsCallbackInterface.OnTestVector2;
                    @TestVector2.performed -= m_Wrapper.m_Sample_UITesterActionsCallbackInterface.OnTestVector2;
                    @TestVector2.canceled -= m_Wrapper.m_Sample_UITesterActionsCallbackInterface.OnTestVector2;
                }
