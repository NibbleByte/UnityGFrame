...
namespace DevLocker.WiseInput.Sample
{
    ...
    ""controlSchemes"": [
        ...
        {
            UnityEngine.Debug.Assert(!m_Sample_PlayJumper.enabled, "This will cause a leak and performance issues, SamplePlayerControls.Sample_PlayJumper.Disable() has not been called.");
            UnityEngine.Debug.Assert(!m_Sample_PlayChopper.enabled, "This will cause a leak and performance issues, SamplePlayerControls.Sample_PlayChopper.Disable() has not been called.");
            UnityEngine.Debug.Assert(!m_Sample_PlayShared.enabled, "This will cause a leak and performance issues, SamplePlayerControls.Sample_PlayShared.Disable() has not been called.");
