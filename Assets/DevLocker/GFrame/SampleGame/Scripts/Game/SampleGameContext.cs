...
{
	public partial class @SampleGamePlayerControls : IInputActionCollection2, IDisposable, IInputContext
	{
	...
	{
		public SampleGameContext(PlayerInput playerInput, SampleGamePlayerControls controls, IInputContext inputContext)
		{
		...
		public SampleGamePlayerControls PlayerControls { get; }
