...
namespace DevLocker.GFrame.Input.UIScope
{
	...
	/// </summary>
	public class UIPlayerRootObject : MonoBehaviour
	{
		...
		public static UIPlayerRootObject GetPlayerUIRootFor(GameObject go)
		{
			var rootObject = go.transform.GetComponentInParent<UIPlayerRootObject>(true);
			if (rootObject) {
				if (!m_PlayerRootObjects.Contains(rootObject)) {
					m_PlayerRootObjects.Add(rootObject);
				}
